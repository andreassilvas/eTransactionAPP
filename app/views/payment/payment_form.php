                    ...
                    <div class="card rounded-4 mt-2">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-6">
                                    <?php
                                    if (isset($_SESSION['expedition_id'])) {
                                        $expeditionModel = new Expedition();
                                        $expedition = $expeditionModel->findWithClientById($_SESSION['expedition_id']);

                                        if ($expedition) {
                                            echo htmlspecialchars($expedition['name']) . " " . htmlspecialchars($expedition['lastname']) . "<br>";
                                            echo htmlspecialchars($expedition['ship_address']) . "<br>";
                                            echo htmlspecialchars($expedition['ship_city']) . ", " . htmlspecialchars($expedition['ship_province']) . ", " . htmlspecialchars($expedition['ship_postcode']) . "<br>";
